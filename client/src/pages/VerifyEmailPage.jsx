					...
					<>
						...
						{demoToken && (
							<div className="mt-5 rounded-2xl border border-highlight/40 bg-highlight/10 p-4 text-left">
								...
								<Link to={`/verify-email?token=${demoToken}`} className="mt-3 inline-flex items-center gap-2 rounded-lg bg-highlight px-4 py-2 text-xs font-bold text-ink transition hover:brightness-105">
